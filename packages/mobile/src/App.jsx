...
const AppTabs = () => (<Tab.Navigator initialRouteName="Discovery" screenOptions={({ route }) => ({
    ...
    return (<ApolloProvider client={client}>
      <MsqThemeContext.Provider value={theme}>
        ...
        headerShown: false,
            ...
            {isSignedIn ? (<RootStack.Screen name="App" component={AppTabs}/>) : (<RootStack.Screen name="Auth">
